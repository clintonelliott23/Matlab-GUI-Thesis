...
PSH_and_KW_Calc(solar_size_input,perf_ratio_input, roof_tilt_input,state_input...
            ,number_people_input,gas_mains_input, pool_input, battery_size_input)                        
...
daily_solar_cost_value = uicontrol('Units', 'normalized', 'Position',[0.8 0.725+y_prod_offset 0.15 0.05], 'Style', 'edit','Parent', TabHandles{production_page,1},...
    'String', '-', 'Visible', 'On','Backgroundcolor', grey, 'Foregroundcolor', 'black', 'FontSize', 10);
...
persistent kw_produced_daily
    function PSH_and_KW_Calc(solar_size_input,perf_ratio_input, roof_tilt_input,state_input...
      ...
      % Need to find the calculations
        ...
        Update_Values_prod(kwhr_avg_found,kw_produced_daily,daily_storage,tariff_rate_normal_found)
         production_graph() 
         cost_analysis()
    end
...
%% Cost Analysis (TAB JUMP)
    ...
    function cost_analysis()
        ...
        Update_Values_cost(electricity_cost_ALCC,electricity_cost_ANNPMT)
    end


function Update_Values_prod(kwhr_avg_found,kw_produced_daily,daily_storage,tariff_rate_normal_found)
      ...
      set(daily_normal_cost_value , 'String', num2str(tariff_rate_normal_found))     
end
function Update_Values_cost(electricity_cost_ALCC,electricity_cost_ANNPMT)
