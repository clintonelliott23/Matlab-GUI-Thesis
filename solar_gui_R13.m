...
percentage_question = uicontrol('Units', 'normalized', 'Position',[0.35 0.7 0.3 0.15], 'Style', 'text',...
    'String', 'What percentage of your electricty do you use doing the day?','Parent', TabHandles{prompt_page,1},...
    'Backgroundcolor', grey, 'Foregroundcolor', 'black', 'FontSize', 20, 'Visible', 'OFF');
...
performance_question = uicontrol('Units', 'normalized', 'Position',[0.35 0.7 0.3 0.15], 'Style', 'text',...
...
% Pre fills all the data instead of going through the process
    function prefill(hObject, eventdata)
                ...
                set(prefill_button,'Visible','OFF')
                    ...
                    cost_solar_input =9000;            set(solar_cost_value, 'String', num2str(cost_solar_input))
                    battery_installed = 1;
                    ...
                    bill_input = 1600;                set(bill_value, 'String', num2str(bill_input) )
...
ROI_title = uicontrol('Units', 'normalized', 'Position',[0.3 0.5+y_prod_offset 0.175/2 0.05], 'Style', 'text','Parent', TabHandles{finance_page,1},...
...
ROI_value = uicontrol('Units', 'normalized', 'Position',[0.3+(0.175/2) 0.5+y_prod_offset 0.15/2 0.05], 'Style', 'edit','Parent', TabHandles{finance_page,1},...
    'String', '-', 'Visible', 'On','Backgroundcolor', grey, 'Foregroundcolor', 'black', 'FontSize', 10);
IRR_value = uicontrol('Units', 'normalized', 'Position',[0.1+(0.175/2) 0.5+y_prod_offset 0.15/2 0.05], 'Style', 'edit','Parent', TabHandles{finance_page,1},...
    'String', '-', 'Visible', 'On','Backgroundcolor', grey, 'Foregroundcolor', 'black', 'FontSize', 10);
...
%                             bar_data_finance(1,i) = (yearly_cost_plot + yearly_cost_witsol_plot);  
              ...
              buddy = bar(haxes3,bar_data_finance','stacked','FaceColor',[0 .8 .5],'EdgeColor','yellow','LineWidth',1.5);
               buddy(2).FaceColor = [.9 .1 .1];
                ...
                % Label, Dimension and Legent the GRPAH
        title('Yearly Cost of Electricity Comparison Between Normal Vs. Solar/Battery','Color','yellow');
...
function progress_bar(progress_step)
        ...
        axes('Units','normalized','Position',[0.8 0.0 0.15 0.0588],'Parent', TabHandles{1,1}); 
        area1 = area([0 progress_step/number_of_inputs],[1 1]); 
        set(gca,'xtick',[]); set(gca,'ytick',[]); 
        set(gca,'xlim',[0 1]);  
        set(gca,'ylim',[0 1]); 
        set(area1,'FaceColor','yellow');   
        uicontrol('Style', 'text','Units', 'normalized','Position', [0.8 0.06 0.15 0.04],'Parent', TabHandles{1,1},... 
            'string',sprintf('Progress: %i%%',round(number_of_inputs*100/number_of_inputs)),'BackgroundColor','white',... 
            'HorizontalAlignment','left','FontName','arial','FontWeight','bold', ... 
            'FontSize', 12);        
end
